...
require(geoR)
elevation.loess = loess(CytoScore~CN*PDL1exp, data = MatchData[l1, ], loess=0.6, degree=1)
...
plot(MatchData$PDL1exp[l1], MatchData$CytoScore[l1], main="PDL1 GE", ylab="cytoscore", xlab="pdl1exp")
